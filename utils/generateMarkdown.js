...
function renderLicenseSection(license) {
  if (license === licenses[0]) {
    return `Documentation for ${licenses[0]} can be found below:`;
  } else if (license === licenses[1]) {
    return `Documentation for ${licenses[1]} can be found below:`;
  } else if (license === licenses[2]) {
    return `Documentation for ${licenses[2]} can be found below:`;
  } else if (license === licenses[3]) {
    return `Documentation for ${licenses[3]} can be found below:`;
  } else if (license === licenses[4]) {
    return `Documentation for ${licenses[4]} can be found below:`;
  } else if (license === licenses[5]) {
    return `Documentation for ${licenses[5]} can be found below:`;
  } else if (license === licenses[6]) {
    return `Documentation for ${licenses[6]} can be found below:`;
  } else if (license === licenses[7]) {
    return `Documentation for ${licenses[7]} can be found below:`;
  } else {
    ""
  }
